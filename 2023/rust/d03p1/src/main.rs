    ...
    for i in matrix_numbers.keys(){
        ...
        for k in start_x..(end_x+1) {
            ...
            if start_y > 0 {
                ...
                if matrix_symbols.contains_key(&key_top) | matrix_symbols.contains_key(&key_topright)  {
                    // i am not sure i need to de-reference here.
                    selected_numbers.push(sel_number_ref);
                    break;
                } 
            }
            ...
            if start_x > 0 {
                ...
                if matrix_symbols.contains_key(&key_left) | matrix_symbols.contains_key(&key_bottomleft) {
                    // i am not sure i need to de-reference here.
                    selected_numbers.push(sel_number_ref);
                    break;
                }
            ...
            if matrix_symbols.contains_key(&key_right) | matrix_symbols.contains_key(&key_bottom) | matrix_symbols.contains_key(&key_bottomright) {
                // i am not sure i need to de-reference here.
                selected_numbers.push(sel_number_ref);
                break;
            }
